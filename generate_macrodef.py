...
def generate_macrodef_fh():
    ...
    if input_data.grid_center_set == "Cell":
        ...
        print()
        print(
            "# Grid center type #define Cell or #define Vertex setting error!",
            file=file1,
        )
        print(file=file1)
    ...
    if input_data.Finite_Diffenence_Method == "2nd-order":
        ...
        print()
        print(
            "# Finite_Difference_Method #define ghost_width setting error!!!",
            file=file1,
        )
        print(file=file1)
    ...
    print(
        "    5: shell with   phi(r) = phi0 * Exp(-(r-r0)**2/sigma), V = 0", file=file1
    )
    print(file=file1)
    print("#endif", file=file1)
    print(file=file1)
